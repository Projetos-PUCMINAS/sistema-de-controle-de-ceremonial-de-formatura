...
INSERT INTO Buffet (cnpj, nome, rua, numero, cep, bairro) VALUES
('12345678000100', 'Buffet Gourmet', 'Rua das Flores', 123, '12345-678', 'Centro'),
('22345678000100', 'Buffet Elegance', 'Av. Paulista', 456, '23456-789', 'Bela Vista'),
('32345678000100', 'Buffet Premium', 'Rua dos Jardins', 789, '34567-890', 'Jardim América');
...
INSERT INTO Evento (id, descricao, local, duracao, num_convidados, data, id_cardapio) VALUES
(1, 'Formatura de Direito', 'Salão A', 5, 200, '2024-12-01', 1),
(2, 'Formatura de Medicina', 'Salão B', 6, 300, '2024-12-15', 2),
(3, 'Formatura de Engenharia', 'Salão C', 4, 150, '2025-01-10', 3);
